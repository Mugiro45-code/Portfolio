...
const About = () => (
  <section className="about-section container my-5 animate__animated animate__fadeInLeft">
    <div className="row align-items-center">
      <div className="col-md-4 text-center mb-4 mb-md-0">
        <img src="/assets/Mugi.jpg" alt="Mugilan S" className="about-avatar shadow" />
      </div>
